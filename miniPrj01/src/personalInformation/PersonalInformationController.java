...
public class PersonalInformationController {
	public void info() throws Exception {
		...
		String sql = "SELECT * FROM PERSONAL_INFORMATION ORDER BY NO";
		...
		while (rs.next()) {
			...
			PersonalInformationVo vo = new PersonalInformationVo(no, affiliation, name, armyNum, rank, address,
					academicBackground, hobby, specialNote, family, familyPhoneNuber, armyJoinYn);
			Util.pvo.add(vo);
		}
	}
	...
	public void signUp() throws Exception {
		...
		if (Util.vo.getSignUpYn().equals("Y")) {
			...
			System.out.println("동반입대 여부(Y/N) : ");
